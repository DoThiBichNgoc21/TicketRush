      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" className="hidden sm:flex gap-2 text-muted-foreground hover:bg-orange-100 hover:text-orange-900 transition-colors">
            ...
            <nav className="flex flex-col gap-2">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  to={link.href}
                  className="px-4 py-2 text-sm font-medium text-muted-foreground hover:text-red-600 hover:bg-secondary rounded-lg transition-colors"
              ...
              <div className="px-4 py-2">
                <p className="text-xs text-muted-foreground mb-2">Dành cho nhà tổ chức</p>
                <Link
                  to="/organizer"
                  className="block px-4 py-2 text-sm font-medium text-muted-foreground hover:text-red-600 hover:bg-secondary rounded-lg transition-colors"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Đăng ký tổ chức sự kiện
                </Link>
              ...
              <div className="flex gap-2 px-4 pt-4 border-t border-border mt-2">
                <Button variant="outline" size="sm" className="flex-1 hover:bg-orange-100 hover:text-orange-900 hover:border-orange-200 transition-colors">
                  Đăng nhập
                </Button>
